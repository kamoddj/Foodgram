...
from api.utils import list_generation
...
class IngredientViewSet(ReadOnlyModelViewSet):
    ...
    Изменение и создание ингридиентов разрешено только администратору.
    """
...
class TagViewSet(ReadOnlyModelViewSet):
    ...
    Изменение и создание тэгов разрешено только администратору.
    """
...
class RecipeViewSet(ModelViewSet):
    ...
    def perform_create(self, serializer):
        """ Выполняет работу по сохранению экземпляра. """
        serializer.save(author=self.request.user)

    def get_serializer_class(self):
        """ Возвращает нужный класс который будет использоваться
        для сериализации в зависимости от входящего запроса.
        """
    ...
    def add_to(self, model, user, pk):
        ...
        Если рецепт уже добавлен выбрасывает ошибку.
        """
    ...
    def delete_from(self, model, user, pk):
        ...
        Если рецепт уже удален выбрасывает ошибку.
        """
    ...
    def download_shopping_cart(self, request):
        ...
        shopping_list = list_generation(ingredients=ingredients,
                                        today=today,
                                        user=user)
